...
Route::group(['middleware' => ['auth','role:admin|operativo|developer']], function()
{
       ...
       Route::group(['middleware' => 'cors','prefix' => 'api'], function()
		{     
			...
			//Ventas Central
			Route::post('/ventasdiaes/{estado}', 'VentasCentralController@indexventasdiaes');
			...
			Route::post('/ventasmeses/{estado}', 'VentasCentralController@indexventasmeses');
			...
			Route::post('/ventasanioes/{estado}', 'VentasCentralController@indexventasanioes');
